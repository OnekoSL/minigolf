...
func _draw() -> void:
	...
	if practice_window >= 0.0:
		var half_width := (size.x - 4.0) * practice_window * 0.5
		draw_rect(Rect2(center_x - half_width, 0, maxf(1, half_width * 2), 5), Color("#397d62"))
