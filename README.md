...
Für **Linux x64** das [tar.gz-Paket](https://github.com/OnekoSL/minigolf/releases/download/v0.7.0/PuttAndPixel-0.7.0-linux-x64.tar.gz) entpacken und `./PuttAndPixel.x86_64` starten. Benötigt werden ein Intel-/AMD-PC mit 64-Bit-Linux, glibc und OpenGL 3.3. Ausführungsrechte sind im Archiv enthalten. [Linux-Anleitung](release/SPIELSTART_LINUX.txt) und [Build-/Prüfablauf](release/README.md#linux-x64) beschreiben Details und Grenzen.
