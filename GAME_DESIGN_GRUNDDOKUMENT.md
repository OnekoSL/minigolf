...
**Klassische Neun** ist ein vollstaendig neu aufgebauter Neun-Loch-Kurs mit Gesamt-Par 18. Je drei Bahnen sind als Par 1, Par 2 und Par 3 ausgelegt; sechs passen fest auf einen Bildschirm, drei scrollen horizontal. Jede Bahn besitzt eine eigene geschlossene Minigolf-Silhouette aus 4-Pixel-Normwaenden und einen klar gefuehrten Spielweg. Der Auftakt oeffnet seinen schmalen Abschlag symmetrisch, Am runden Stein sperrt die direkte Diagonale mit einem zentralen Kreisbumper, und Bogenschuss fuehrt durch einen aus zwei angeschlossenen Viertelboegen gebildeten Hals. Das Hufeisen schliesst seinen Zielbogen mit zwei Normwandarmen, Zwei Kreise versetzt zwei Bumper zu einer S-Linie, und Die Engstelle kombiniert eine diagonale Sanduhrkontur mit zwei angeschlossenen Boegen. Der Zickzack-Weg erzwingt mit zwei gegensinnigen 45-Grad-Normwandbaendern den Seitenwechsel. Kreisallee ordnet fuenf kleinere Bumper abwechselnd an oberer und unterer Bande an. Die Heimkehr bildet aus zwei konzentrischen Boegen und acht Normwandsegmenten eine geschlossene Wendekammer. Insgesamt bleiben exakt acht Kreisbumper und sieben Kreisboegen erhalten. Nur Bogenschuss, Die Engstelle und Kreisallee verwenden je zwoelf atomare, flache dunkelgruene 16-x-16-Pixel-Pfeilzellen mit `30 px/s²` Rollwiderstand und ohne Mindesttempo, Ausrichtung oder Zentrierung. Legacy-Gefaelleflaechen, Sand, Wasser und bewegliche Mechaniken werden nicht verwendet. Loch 1 bis 3 sind reproduzierbar mit einem Schlag loesbar; Loch 4 bis 6 besitzen sichere Zweischlag- und riskante Ein-Schlag-Routen, Loch 7 bis 9 sichere Dreischlag- und riskante Zweischlag-Routen. Wegen des grundlegenden Umbaus verwendet nur dieser Kurs den neuen Bestwertschluessel `classic_nine_course_v2`.

**Pfeil-Armageddon** ist ein vollstaendiger Neun-Loch-Gefaellekurs mit Gesamt-Par 27. Je drei Bahnen sind als Par 2, Par 3 und Par 4 ausgelegt; fuenf bleiben kompakt, vier scrollen horizontal. Alle neun Loecher wurden als eigene geschlossene Minigolf-Silhouetten aus 4-Pixel-Normwaenden neu aufgebaut. Jede Bahn unterbricht den neutralen Spielweg mit mindestens einem nicht seitlich umgehbaren Pfeil-Kernfeld. Die Progression lehrt in Loch 1 bis 3 flache dunkelgruene Felder, praegt Loch 4 bis 6 durch mittlere dunkelblaue Felder und macht ab Loch 7 steile dunkelrote Gegen- und Querpassagen zur Hauptgefahr. Insgesamt 867 Zellen verwenden alle acht Richtungen. Jede Zelle ist ein einzelnes, exakt 16 x 16 Pixel grosses achsenparalleles Quadrat; groessere Felder bestehen ausschliesslich aus solchen Rasterzellen. Drei feste Steigungsstufen steuern Farbe und Physik gemeinsam: flach mit `60 px/s²` in Dunkelgruen, mittel mit `90 px/s²` in Dunkelblau und steil mit `150 px/s²` in Dunkelrot. Alle Zellen besitzen `30 px/s²` Rollwiderstand und keinerlei Mindesttempo, Maximaltempo, automatische Ausrichtung oder Zentrierung. Dadurch beschleunigen sie bergab netto mit `30`, `60` und `120 px/s²`; gegen den Pfeil bremsen sie mit `90`, `120` und `180 px/s²`, sodass ein zu langsamer Ball stoppt und anschliessend in Pfeilrichtung zurueckrollt. Nur die Pfeilspirale besitzt eine Sand-Auffangzone und nur der Gegenstrom zwei Wasserbecken; bewegliche Mechanik wird nicht verwendet. Jede Bahn besitzt eine automatisiert bestaetigte Idealloesung innerhalb ihres Pars. Der grundlegende Umbau setzt nur fuer diesen Kurs die Bestwertrevision auf 2, sodass alte Ergebnisse nicht als Rekord der neuen Bahnen erscheinen.
