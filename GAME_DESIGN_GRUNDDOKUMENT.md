...
**Erweiterung – Übung und Tutorial:** Der Übungsbereich verbindet einen dreiteiligen Grundkurs, acht frei anwählbare Lektionen mit eigenen Lernbahnen und freies Training auf den bestehenden Kurs- und Technikbahnen. Er startet ohne Spieleranlage mit Ben; im freien Training stehen alle Golfer bereit. Ohne Schlaglimit und Kurswertung lassen sich der letzte Schlag einschließlich Hinderniszuständen zurücksetzen und Ballspuren vergleichen. Dreieck/F2 öffnet die Trainingshilfen. Lernfortschritt wird getrennt gespeichert. Umfang, Bedienung und Prüfungen stehen in [UEBUNG.md](UEBUNG.md); historische F2-Beschreibungen unten gelten für den früheren Prototyp.
